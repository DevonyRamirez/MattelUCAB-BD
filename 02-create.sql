...
create table PAGO_B2B (
   ...
   constraint chk_pago_b2b_transferencia_cheque check ((FK_TRANSFERENCIA IS NOT NULL AND FK_CHEQUE IS NULL) OR (FK_TRANSFERENCIA IS NULL AND FK_CHEQUE IS NOT NULL))
);
...
create table CORREO (
   ...
   constraint chk_correo_b2b_b2c_empleado check ((FK_PERSONA_JURIDICA IS NOT NULL and FK_PERSONA_NATURAL_CLIENTE IS NULL and FK_PERSONA_NATURAL_EMPLEADO IS NULL) OR (FK_PERSONA_JURIDICA is null and FK_PERSONA_NATURAL_CLIENTE is not null and FK_PERSONA_NATURAL_EMPLEADO is null) or (FK_PERSONA_JURIDICA is null and FK_PERSONA_NATURAL_CLIENTE is null and FK_PERSONA_NATURAL_EMPLEADO is not null))
);
...
create table TELEFONO (
   ...
   constraint chk_telefono_b2b_b2c_empleado check ((FK_PERSONA_JURIDICA IS NOT NULL and FK_PERSONA_NATURAL_CLIENTE IS NULL and FK_PERSONA_NATURAL_EMPLEADO IS NULL) OR (FK_PERSONA_JURIDICA is null and FK_PERSONA_NATURAL_CLIENTE is not null and FK_PERSONA_NATURAL_EMPLEADO is null) or (FK_PERSONA_JURIDICA is null and FK_PERSONA_NATURAL_CLIENTE is null and FK_PERSONA_NATURAL_EMPLEADO is not null))
...
create table USUARIO (
   ...
   constraint chk_persona_b2c_b2c_empleado check ((FK_PERSONA_JURIDICA IS NOT NULL and FK_PERSONA_NATURAL_CLIENTE IS NULL and FK_PERSONA_NATURAL_EMPLEADO IS NULL) OR (FK_PERSONA_JURIDICA is null and FK_PERSONA_NATURAL_CLIENTE is not null and FK_PERSONA_NATURAL_EMPLEADO is null) or (FK_PERSONA_JURIDICA is null and FK_PERSONA_NATURAL_CLIENTE is null and FK_PERSONA_NATURAL_EMPLEADO is not null))
);
...
create table USUARIO_METODO_PAGO (
   ...
   constraint PK_USUARIO_METODO_PAGO primary key (ID_USUARIO_METODO_PAGO),
    ...
    constraint chk_usuario_metodopago_TDD_TDC check ((FK_TARJETA_CREDITO is not null and FK_TARJETA_DEBITO is null)
    or (FK_TARJETA_CREDITO is null and FK_TARJETA_DEBITO is not null) )
);
...
create table PAGO_B2C (
   ...
   constraint chk_metodopago_b2c_paypal_cripto_tdc_tdd check ((FK_PAYPAL IS NOT NULL AND FK_CRIPTOMONEDA IS NULL AND FK_TARJETA_CREDITO IS NULL AND FK_TARJETA_DEBITO IS NULL )
      OR (FK_PAYPAL IS NULL AND FK_CRIPTOMONEDA IS NOT NULL AND FK_TARJETA_CREDITO IS NULL AND FK_TARJETA_DEBITO IS NULL )
      OR (FK_PAYPAL IS NULL AND FK_CRIPTOMONEDA IS NULL AND FK_TARJETA_CREDITO IS NOT NULL AND FK_TARJETA_DEBITO IS NULL )
      OR (FK_PAYPAL IS NULL AND FK_CRIPTOMONEDA IS NULL AND FK_TARJETA_CREDITO IS NULL AND FK_TARJETA_DEBITO IS NOT NULL ))
);
